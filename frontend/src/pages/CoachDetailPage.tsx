...
export function CoachDetailPage() {
  ...
  if (!coach) {
    return (
      <div className="text-center py-12">
        ...
        <Button variant="secondary" onClick={() => navigate('/coaches')} className="mt-4">
          Back to Coaches
        </Button>
      </div>
    )
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <Card>
        <h1 className="text-2xl font-bold text-gray-900 mb-6">{coach.name}</h1>
        ...
        {coach.club && (
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              To release this coach, go to the{' '}
              <Link
                to={`/clubs/${coach.club.id}`}
