...
import { useFreePlayers, useAssignPlayer } from '../../hooks'
...
export function AssignPlayerModal({
  ...
  const { data: freePlayers, isLoading } = useFreePlayers()
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Assign Player">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <p className="text-sm text-gray-500">No free players available</p>
          ) : (
            <select
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <Button
            ...
            disabled={exceedsBudget || !freePlayers?.length}
          >
            Assign Player
          </Button>
        </div>
